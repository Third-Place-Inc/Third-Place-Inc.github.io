...
export async function generateMetadata({ params }: productDetailPageProps): Promise<Metadata> {
  ...
  const defaultTitle = "Contents";
  const defaultDescription = "This is a project involving Third Place Inc.";
  ...
  return {
    ...
    openGraph: {
      type: "article",
      url: `https://third-place-inc.github.io/en/product/${slug}`,
      title: data.title || defaultTitle,
      description: data.description || defaultDescription,
...
export async function generateStaticParams() {
  const productDir = path.join(process.cwd(), "content/en/product");
